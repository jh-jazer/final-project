...
const ApplyProcedures = () => {
  const steps = [
    ...
    "Fill up the application form in the admission portal and upload documentary requirements.",
    ...
    "Interview at the department of your chosen course.",
  ...
  const documents = [
    "Grade 12 Report Card (Certificate of Rating for ALS Passer)",
