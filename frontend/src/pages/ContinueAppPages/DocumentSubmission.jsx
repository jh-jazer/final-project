...
<div className="flex justify-center bg-white shadow-lg py-[5%] rounded-lg items-center flex-col h-full">
  <h5 className="text-2xl font-extrabold text-[#1b1b1b] mb-6 pt-8">Your Submission Schedule</h5>
  ...
  <div><p className="text-lg mt-3 text-gray-500">Once your documents are submitted, you can proceed to Society Payments</p></div>
