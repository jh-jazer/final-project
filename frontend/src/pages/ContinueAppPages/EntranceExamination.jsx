...
<div className="flex justify-center bg-white shadow-lg py-[5%] rounded-lg items-center flex-col h-full">
  <h5 className="text-2xl font-extrabold text-[#1b1b1b] mb-6 pt-8">Your Examination Schedule</h5>
  ...
  <div><p className="text-lg mt-3 text-gray-500">Make sure to bring a valid ID and a printed copy of your application form</p></div>
        ...
        <div className="mt-6 w-full max-w-4xl p-4 bg-green-100 border-l-4 border-green-500 text-gray-700">
          ...
          <ul className="list-disc pl-6">
            <li>
              Taking your examination is only allowed on your examination scheduled . Arriving on a different date 
