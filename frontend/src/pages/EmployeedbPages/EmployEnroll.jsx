...
const SocietyPayments = () => {
  ...
  const [enrolleeTypeFilter, setEnrolleeTypeFilter] = useState('All');
  ...
  const filteredEnrollments = enrollments
    .filter((enrollee) => {
      return (
        ...
        (enrolleeTypeFilter === 'All' || enrollee.enrolleeType === enrolleeTypeFilter)
      );
    })
    .sort((a, b) => {
      if (sortBy === 'name') {
          ...
          <table className="min-w-full table-auto border-collapse">
            <thead>
              <tr className="bg-gray-200">
                ...
                <th className="px-4 py-2 text-left border border-gray-300">Requirements </th>
                <th className="px-4 py-2 text-left border border-gray-300">Checklist </th>
                <th className="px-4 py-2 text-left border border-gray-300">Society Fee </th>
              ...
              {filteredEnrollments
                ...
                .map((enrollee) => (
                  <tr key={enrollee.id} className="hover:bg-gray-100">
                    ...
                    <td className="px-4 py-2 border border-gray-300">{enrollee.checklistValid}</td>
